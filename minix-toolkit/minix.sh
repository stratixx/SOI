...
QEMU_CMD='qemu-system-x86_64'																# Nazwa polecenia emulatoara
...
MINIX_SOURCE_URL='http://www.ia.pw.edu.pl/~tkruk/edu/soib/lab/minix/minix203.img'		# Skąd pobieramy czysty obraz?
